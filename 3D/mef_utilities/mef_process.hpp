float calculate_local_area(float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3, float x4, float y4, float z4){
    Matrix Area(4,4);
    Area.set(x1, 0,0); Area.set(y1, 0,1); Area.set(z1, 0,2); Area.set(1, 0,3);
    Area.set(x2, 1,0); Area.set(y2, 1,1); Area.set(z2, 1,2); Area.set(1, 1,3);
    Area.set(x3, 2,0); Area.set(y3, 2,1); Area.set(z3, 2,2); Area.set(1, 2,3);
    Area.set(x4, 3,0); Area.set(y4, 3,1); Area.set(z4, 3,2); Area.set(1, 3,3);
    float A = abs(determinant(&Area))/6;
...
float calculate_local_jacobian(float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3, float x4, float y4, float z4){
    Matrix J(3,3);
    J.set(x2-x1, 0,0); J.set(x3-x1, 0,1); J.set(x4-x1, 0,2);
    J.set(y2-y1, 1,0); J.set(y3-y1, 1,1); J.set(y4-y1, 1,2);
    J.set(z2-z1, 2,0); J.set(z3-z1, 2,1); J.set(z4-z1, 2,2);
    float Jacobian = determinant(&J);
    return ((Jacobian==0)?0.000001:Jacobian);
}
